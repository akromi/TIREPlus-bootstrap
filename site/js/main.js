document.addEventListener('DOMContentLoaded', function () {
  ...
  var langMap = {
    ...
    '/about/': '/fr/a-propos/',
    '/search/': '/fr/recherche/',
    '/request-service/': '/fr/demande-de-service/',
    '/book-appointment/': '/fr/prendre-rendez-vous/',
    '/faq/': '/fr/faq/',
    ...
    '/fr/a-propos/': '/about/',
    '/fr/recherche/': '/search/',
    '/fr/demande-de-service/': '/request-service/',
    '/fr/prendre-rendez-vous/': '/book-appointment/',
    '/fr/faq/': '/faq/',
